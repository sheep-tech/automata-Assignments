...
statement	: assign | loop | print | expr | ifStat | url | declareFunStat | funCall | returnExpr;
...
ifStat		: IF boolExpr THEN (then_stat) ( ELSE else_stat )? FI;
...
boolExpr    : expr AND expr		        # andExpr
            ...
            | FALSE                     # falseExpr
;
returnExpr  : RETURN boolExpr   #returnBoolExpr
            | RETURN expr      #returnCommonExpr
;
numberA		: NUMBER;
numberB		: NUMBER;
numberC		: NUMBER;
